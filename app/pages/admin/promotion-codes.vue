  ...
  <div class="flex flex-col h-full overflow-hidden">
    ...
    <Teleport to="body">
      <Transition enter-active-class="transition duration-200 ease-out" enter-from-class="opacity-0" enter-to-class="opacity-100" leave-active-class="transition duration-150 ease-in" leave-from-class="opacity-100" leave-to-class="opacity-0">
        <div v-if="isViewModalOpen && viewingBatch" class="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-surface-950/90" @mousedown.self="isViewModalOpen = false">
...
import { db } from '~/db'
import PromotionCodeCreateModal from '~/components/admin/PromotionCodeCreateModal.vue'
...
const { loadBatches, loadCodes, deleteBatch } = usePromotionCodes()
