...
// guard: ป้องกัน generate ซ้ำในวันเดียว (date string แทน boolean เพื่อรองรับแท็บเล็ตเปิดข้ามวัน)
let lastAutoGenerateDate: string | null = null
...
export function useRecurringExpenses() {
  ...
  async function generatePendingExpenses(): Promise<number> {
    ...
    if (lastAutoGenerateDate === today) return 0
